...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(15,15,15,1)"}},
            inactive_border = "rgba(15,15,15,1)",
        },
...
hl.bind("Print", function()
    -- Region select
    hl.exec_cmd('slurp -w 0 | xargs -I {} sh -c \'grim -g "{}" - | tee "/screenshot-$(date +%Y-%m-%d_%H-%M-%S).png" | wl-copy\'')
...
local calendarRule = hl.window_rule({
